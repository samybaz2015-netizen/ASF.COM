...
{
    public class EmergencySpecification : BaseSpecification<Emergency>
    {
        public EmergencySpecification()
        {
            AddInclude(o => o.SitePhotos);
            AddInclude(o => o.ModelPhotos);
            AddInclude(o => o.SafetyWastePhotos);
        }
        public EmergencySpecification(bool? isArchive, int? sort, int pageSize, int pageIndex)
        {
            AddInclude(o => o.SitePhotos);
            AddInclude(o => o.ModelPhotos);
            AddInclude(o => o.SafetyWastePhotos);
        ...
        public EmergencySpecification(string? branchName, bool? isArchive) //: base(i => i.BranchName==branchName && i.isArchive==isArchive)
        {
        ...
        public EmergencySpecification(int id) : base(o => o.Id.Equals(id))
        {
        ...
        public EmergencySpecification(string? userId, string? branchName)
