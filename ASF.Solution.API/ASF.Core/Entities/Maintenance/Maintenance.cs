...
{
    public class Maintenance : IProjectEntity, IListLinkedWorkOrder
    {
        ...
        public List<ModelPhotoForMaintenance>? ModelPhotos { get; set; }
        public List<ModelTestForMaintenance>? TestModels { get; set; }
        public List<SitePhotoForMaintenance>? SitePhotos { get; set; }
        public List<SafetyWastePhotoForMaintenance>? SafetyWastePhotos { get; set; }

        // البنود التسعيرية
        public List<MaintenancePricingItem>? MaintenancePricingItems { get; set; }

        public Maintenance()
        {
            ModelPhotos = new List<ModelPhotoForMaintenance>();
            SitePhotos = new List<SitePhotoForMaintenance>();
            SafetyWastePhotos = new List<SafetyWastePhotoForMaintenance>();
            TestModels = new List<ModelTestForMaintenance>();
            MaintenancePricingItems = new List<MaintenancePricingItem>();
        }
    ...
    // جدول الربط
    public class MaintenancePricingItem : IProjectPricingItem
    {
        public int Id { get; set; }
